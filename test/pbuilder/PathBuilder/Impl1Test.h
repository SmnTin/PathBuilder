...
//                                  1);
//
//        MatInt mat1 = MatInt::createFromVector(2, 2,
//                                               {0, 1,
//                                                1, 0}
//        );
//        MatInt mat2 (2, 2, 0);
...
//    }
//
//    TEST(PathBuilderImpl1, PlaceWithFreeTimeTest) {
//        auto _pathBuilder = PathBuilder::createImpl1();
//
//        PlaceWithFreeTime place1(Coordinates{10, 0},
//                                  TimePoint(0),
//                                  TimePoint(INF),
//                                  TimePoint(0),
//                                  100,
...
//                                  0);
//
//        MatInt mat1 = MatInt::createFromVector(1, 1,
//                                               {0}
//        );
//        MatInt mat2 (1, 1, 0);
//        MatInt mat3 (1, 1, 0);
...
//
//        _pathBuilder->setPlaces({
//                                        std::make_shared<PlaceWithFreeTime>(place1)
//                                });
//        _pathBuilder->setMatrices({
//                                          std::make_shared<MatInt>(mat1),
//                                          std::make_shared<MatInt>(mat2),
